...
/**
 * The NewRegistry model module.
 * @module model/NewRegistry
 * @version 1.0
 */
class NewRegistry {
    /**
     * Constructs a new <code>NewRegistry</code>.
     * @alias module:model/NewRegistry
     * @param id {String} 
     */
    constructor(id) { 
        
        NewRegistry.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>NewRegistry</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewRegistry} obj Optional instance to populate.
     * @return {module:model/NewRegistry} The populated <code>NewRegistry</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new NewRegistry();
    ...
    /**
     * Validates the JSON data with respect to <code>NewRegistry</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewRegistry</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewRegistry.RequiredProperties) {
            if (!data[property]) {
...
NewRegistry.RequiredProperties = ["id"];

/**
 * @member {String} id
 */
NewRegistry.prototype['id'] = undefined;

/**
 * @member {Array.<module:model/RegistryCredential>} credentials
 */
NewRegistry.prototype['credentials'] = undefined;

/**
 * @member {module:model/HttpConfig} httpConfig
 */
NewRegistry.prototype['httpConfig'] = undefined;

/**
 * @member {module:model/MqttConfig} mqttConfig
 */
NewRegistry.prototype['mqttConfig'] = undefined;

/**
 * @member {module:model/LogLevel} logLevel
 */
NewRegistry.prototype['logLevel'] = undefined;

/**
 * @member {Array.<module:model/EventNotificationConfig>} eventNotificationConfigs
 */
NewRegistry.prototype['eventNotificationConfigs'] = undefined;

/**
 * @member {module:model/NotificationConfig} logNotificationConfig
 */
NewRegistry.prototype['logNotificationConfig'] = undefined;

/**
 * @member {module:model/NotificationConfig} stateNotificationConfig
 */
NewRegistry.prototype['stateNotificationConfig'] = undefined;
