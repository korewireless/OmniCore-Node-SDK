...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.DeviceCredential();
  });
  ...
  describe('DeviceCredential', function() {
    it('should create an instance of DeviceCredential', function() {
      // uncomment below and update the code to test DeviceCredential
      //var instance = new OmniCoreModelAndStateManagementApi.DeviceCredential();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.DeviceCredential);
    });
