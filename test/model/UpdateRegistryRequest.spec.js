...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.UpdateRegistryRequest();
  });
  ...
  describe('UpdateRegistryRequest', function() {
    it('should create an instance of UpdateRegistryRequest', function() {
      // uncomment below and update the code to test UpdateRegistryRequest
      //var instance = new OmniCoreModelAndStateManagementApi.UpdateRegistryRequest();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.UpdateRegistryRequest);
    });
