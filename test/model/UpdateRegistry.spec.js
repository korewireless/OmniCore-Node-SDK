...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.UpdateRegistry();
  });
  ...
  describe('UpdateRegistry', function() {
    it('should create an instance of UpdateRegistry', function() {
      // uncomment below and update the code to test UpdateRegistry
      //var instance = new OmniCoreModelAndStateManagementApi.UpdateRegistry();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.UpdateRegistry);
    });
