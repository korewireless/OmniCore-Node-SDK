...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.NewRegistry();
  });
  ...
  describe('NewRegistry', function() {
    it('should create an instance of NewRegistry', function() {
      // uncomment below and update the code to test NewRegistry
      //var instance = new OmniCoreModelAndStateManagementApi.NewRegistry();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.NewRegistry);
    });
