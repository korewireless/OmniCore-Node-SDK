...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.UpdateDevice();
  });
  ...
  describe('UpdateDevice', function() {
    it('should create an instance of UpdateDevice', function() {
      // uncomment below and update the code to test UpdateDevice
      //var instance = new OmniCoreModelAndStateManagementApi.UpdateDevice();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.UpdateDevice);
    });
