...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OmniCoreModelAndStateManagementApi.ListDevicesResponse();
  });
  ...
  describe('ListDevicesResponse', function() {
    it('should create an instance of ListDevicesResponse', function() {
      ...
      //var instance = new OmniCoreModelAndStateManagementApi.ListDevicesResponse();
      //expect(instance).to.be.a(OmniCoreModelAndStateManagementApi.ListDevicesResponse);
    });
